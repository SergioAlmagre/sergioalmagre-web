  ...
  const translations = {
    en: {
      ...
      index: {
        ...
        newsletterLabel: "// signal_subscribe",
        newsletterTitle: "Receive the signal",
        newsletterStatus: "channel open",
        newsletterHeading: "A few useful transmissions. No noise.",
        newsletterDescription: "Occasional notes about backend, cloud, automation and the things I am building. I will keep the frequency low and the signal useful.",
        newsletterPointOne: "Projects, experiments and technical notes",
        newsletterPointTwo: "New audiovisual gear when it reaches the catalog",
        newsletterPointThree: "No spam or unnecessary emails",
        newsletterEmailLabel: "Email",
        newsletterEmailPlaceholder: "you@example.com",
        newsletterConsent: "I agree to receive the newsletter by email.",
        newsletterSubmit: "Join the channel →",
        newsletterNote: "One email when there is something worth sending.",
        newsletterSending: "Opening channel...",
        newsletterSuccess: "You are on the list. Thanks for subscribing.",
        newsletterAlreadySubscribed: "This email is already subscribed.",
        newsletterInvalid: "Please enter a valid email.",
        newsletterConsentError: "Please accept the consent checkbox to continue.",
        newsletterError: "The channel could not be opened. Please try again later.",
    ...
    es: {
      ...
      index: {
        ...
        newsletterLabel: "// suscripcion",
        newsletterTitle: "Recibe la señal",
        newsletterStatus: "canal abierto",
        newsletterHeading: "Unas pocas transmisiones útiles. Sin ruido.",
        newsletterDescription: "Notas ocasionales sobre backend, cloud, automatización y lo que estoy construyendo. Mantendré la frecuencia baja y la señal útil.",
        newsletterPointOne: "Proyectos, experimentos y notas técnicas",
        newsletterPointTwo: "Nuevo material audiovisual cuando llegue al catálogo",
        newsletterPointThree: "Sin spam ni emails innecesarios",
        newsletterEmailLabel: "Email",
        newsletterEmailPlaceholder: "tu@email.com",
        newsletterConsent: "Acepto recibir la newsletter por email.",
        newsletterSubmit: "Unirme al canal →",
        newsletterNote: "Un email solo cuando haya algo que merezca la pena enviar.",
        newsletterSending: "Abriendo canal...",
        newsletterSuccess: "Ya estás en la lista. Gracias por suscribirte.",
        newsletterAlreadySubscribed: "Este email ya está suscrito.",
        newsletterInvalid: "Introduce un email válido.",
        newsletterConsentError: "Acepta la casilla de consentimiento para continuar.",
        newsletterError: "No se ha podido abrir el canal. Inténtalo de nuevo más tarde.",
